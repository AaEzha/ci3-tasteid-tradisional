		...
		<div class="card">
			<div class="card-body">
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" name="nama" id="nama" value="<?php echo $data->nama_user ?? set_value('nama'); ?>" placeholder="Nama Admin">
				</div>
				...
				<a class="btn btn-dark" href="<?= base_url('admin'); ?>" role="button" onclick="return confirm('Are you sure?')">Batal</a>
				</form>
			</div>
		</div>
	</div>
